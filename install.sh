...
apt install -y ufw redis-server ffmpeg wget python3-pip nginx-full
...
su - o11 -c "pip3 install --user --break-system-packages pycurl bs4 curl_cffi redis pywidevine pyplayready requests pytz dnspython requests_toolbelt PySocks"
